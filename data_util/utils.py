...
def calc_running_avg_loss(loss, running_avg_loss, summary_writer, step, decay=0.99):
  ...
  run_loss_sum = tf.Summary()
  tag_name = 'running_avg_loss/decay=%f' % (decay)
  run_loss_sum.value.add(tag=tag_name, simple_value=running_avg_loss)
  summary_writer.add_summary(run_loss_sum, step)

  loss_sum = tf.Summary()
  loss_sum.value.add(tag='loss', simple_value = loss)
